...
import { CalendarDays, BarChart3, FileText, HelpCircle, Home, LogOut, Moon, Settings, Sun, Users, ImageIcon, BookOpen } from "lucide-react";
...
const mainMenuItems = [
  ...
  { title: "Articles", icon: BookOpen, path: "/articles" },
